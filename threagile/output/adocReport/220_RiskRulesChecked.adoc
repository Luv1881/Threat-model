...
| Threagile Build Timestamp:     | 20260523112448
| Threagile Execution Timestamp: | 20260523112503
| Model Filename:                | /app/work/threagile.yaml
| Model Hash (SHA256):           | 774c898d4f3b0ed271aba4c7150c9cea775c2aea5a63edcdafe444d6aa0ccd57
|===
...
[.small]#hardcoded-credentials#


[cols="h,1",frame=none,grid=none]
|===
| STRIDE:      | Information Disclosure
| Description: | Container deployments that rely on default or hardcoded credentials (e.g. minioadmin/minioadmin visible in docker-compose.yml) expose datastores to any process that can read the configuration.
| Detection:   | In-scope datastore technical assets tagged with intentional-misconfiguration.
| Rating:      | Datastores tagged intentional-misconfiguration carrying confidential or stricter data warrant at least an elevated severity because credential theft directly enables data exfiltration.
|===
